  ...
  return (
    <>
      ...
      <section className="bg-black py-12 px-4 text-center">
        <h2 className="text-3xl md:text-4xl font-bold tracking-wider text-amber-500 uppercase font-[Merriweather] mb-12">
          Event Photos
        </h2>

        <div className="flex flex-col lg:flex-wrap lg:flex-row justify-center items-center gap-8">
          {event.images.map((photo, idx) => {
            const isCenter = photo.variant === "center";
        ...
        `}
            ...
            ${
              isCenter
                ? "(min-width: 1024px) 600px, 60vw"
                : "(min-width: 1024px) 240px, 28vw"
            }
          `}
                />
              </div>
